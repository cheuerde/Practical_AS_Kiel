...
The vector $x$ contains a "feature" or regression variable that establishes a connection with the observations.o
...
normal distribution. Now we estimate the mean with OLS:
...
## Adding Features to the Design Matrix: Multiple Regression

When there is more than one feature in the design matrix we call that Multiple Linear Regression.
The overall principal of the problem remains the same: We aim to minimize the mean squared error
of our predictions.
