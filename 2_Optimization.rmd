...
the sum of both variables minus the square of the first variable.
...
valued variables, the precission matters as well.
...
by evaluating the objective function for all possible realisation of $x_1$ and $x_2$.
