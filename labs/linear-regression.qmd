...
In the plots below, the vertical segments show residuals $e_i = y_i - \hat{y}_i$.
The shaded squares visualize the contribution of selected residuals to the squared-error criterion.
...
resid_squares = residual_square_data(dat, "id", "y", "pred", every = 12, scale = 0.20)
...
resid_squares = residual_square_data(dat, "Temp", "Wind", "pred", every = 12, scale = 0.45)
