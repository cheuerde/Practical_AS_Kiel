...
toy_least_squares_plot = ggplot(toy_dat, aes(x = x, y = y)) +
  geom_rect(
    data = toy_squares,
...
toy_least_squares_plot
```

## Toy Least-Squares Plot
...
predicted_observed_plot = ggplot(dat, aes(x = y, y = pred)) +
 geom_point() +
...
fitted_slope_plot = ggplot(dat, aes(x = Temp, y = Wind)) +
...
## Closed-Form Ridge Solution {.smaller}
