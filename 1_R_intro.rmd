...
For all relevant porpuses of the tutorial, we can safely use either of those operator interchably.
...
All operators in R are function, for instance `+` is just a special way
...
and return the empirical mean (average) of a numeric vector:
...
the functions the operators `+` and `/` are defined.
